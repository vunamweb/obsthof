...
class ControllerCatalogProduct extends Controller {
    ...
    public function add() {
        ...
        if ( ( $this->request->server[ 'REQUEST_METHOD' ] == 'POST' ) && $this->validateForm() ) {
            ...
            $this->response->redirect( $this->url->link( 'catalog/product', 'user_token=' . $this->session->data[ 'user_token' ] . $url . '&type='.$type.'', true ) );
        }
    ...
    protected function getList() {
        ...
        if ( $type )
        $data[ 'add' ] = $this->url->link( 'catalog/product/add', 'type=1&user_token=' . $this->session->data[ 'user_token' ] . $url, true );
        else
    ...
    protected function getForm() {
        ...
        $data[ 'cancel' ] = $this->url->link( 'catalog/product', 'user_token=' . $this->session->data[ 'user_token' ] . $url . '&type='.$type.'', true );
        ...
        if ( isset( $this->request->post[ 'price_1' ] ) ) {
            ...
            $data[ 'price_1' ] = $product_info[ 'price_1' ];
        } else {
            $data[ 'price' ] = '';
        }
        ...
        if ( $type )
        $this->response->setOutput( $this->load->view( 'catalog/product_form_event', $data ) );
        else
