	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($catalog) {
				...
				$events[] = array(
					'name'	   => $this->language->get('text_category'),
					'href'     => $this->url->link('catalog/category', 'type=1&user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
				$events[] = array(
					'name'	   => $this->language->get('text_product'),
					'href'     => $this->url->link('catalog/product', 'type=1&user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
				...
				$data['menus'][] = array(
					'id'       => 'menu-catalog',
					'icon'	   => 'fa-tags',
					'name'	   => $this->language->get('text_event_shop'),
					'href'     => '',
					'children' => $events
				);
			}
			...
			$data['menus'][] = array(
				'id'       => 'menu-catalog___',
				'icon'	   => 'fa-tags',
				'name'	   => 'Event Liste Export',
				'href'     => $this->url->link('catalog/category/event', 'type=1&user_token=' . $this->session->data['user_token'], true),
			);
			// END
