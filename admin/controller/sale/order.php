...
class ControllerSaleOrder extends Controller {
    ...
    protected function getList() {
        ...
        foreach ( $results as $result ) {
            ...
            $totalOrder = ( $this->model_sale_order->isIncludeTax( $result[ 'order_id' ] ) ) ? $result[ 'total' ] : $result[ 'total' ] - $costShiping;
            //( in_array( $result[ 'order_status_id' ], array( 13 ) ) ) ? $result[ 'total' ] * -1 : $result[ 'total' ];
