...
$output .= '
	<div class="video_wrapper" style="background-image: url( \'https://img.youtube.com/vi/'.trim($video).'/hqdefault.jpg\' );">
		<div class="video_trigger" data-source="'.trim($video).'" data-type="youtube">
			<p class="text-center">Mit dem Aufruf des Videos erklären sie sich einverstanden, dass ihre Daten an YouTube übermittelt werden und das sie die <a href="'.getUrl(8).'">Datenschutzerklärung</a> gelesen haben.</p>
