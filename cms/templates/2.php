...
<section class="section_multi '.($tref == 6 ? ' ' : '').($klasse ? $klasse : '').($tclass ? $tclass.' ' : '').($class ? $class.' bg-color' : '').($tabstand ? ' pt0 ' : '').($tabstand_bottom? ' pb0 ' : '').'"'.($farbe ? ' style="background:#'.$farbe.';"' : '').($anker ? ' id="'.$anker.'"' : '').'>
